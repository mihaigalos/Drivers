...
static uint8_t buffer[SSD1306_LCDHEIGHT * SSD1306_LCDWIDTH / 8] = {
    ...
    0x00, 0x00, 0x00, 0x00,
#if (SSD1306_LCDHEIGHT * SSD1306_LCDWIDTH >                                    \
     64 * 32) // added for 64x32 display option
    ,
    ...
    0x03, 0x01, 0x00, 0x00, 0x00, 0x01, 0x03, 0x01, 0x00, 0x00, 0x00, 0x03,
...
void Adafruit_SSD1306::display(void) {
  ...
  ssd1306_command(0x20);  // Column start address (0x20 = reset) - 64 pixel wide
                          // displays have starting values offset
  ssd1306_command(0x20 + (SSD1306_LCDWIDTH - 1)); // Column end address (127 =
                                                  // reset)  - 64 pixel wide
                                                  // displays have starting
                                                  // values offset - could use
                                                  // static 0x5F here
#else
