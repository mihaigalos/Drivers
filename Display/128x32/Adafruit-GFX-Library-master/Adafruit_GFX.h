...
public:
  ...
  void drawCircle(int16_t x0, int16_t y0, int16_t r, uint16_t color),
      ...
      setTextWrap(boolean w), setRotation(uint8_t r), cp437(boolean x = true),
      setFont(const GFXfont *f = NULL),
      getTextBounds(char *string, int16_t x, int16_t y, int16_t *x1,
  ...
  // get current cursor position (get rotation safe maximum values, using:
...
public:
  ...
  void initButton(Adafruit_GFX *gfx, int16_t x, int16_t y, uint8_t w, uint8_t h,
