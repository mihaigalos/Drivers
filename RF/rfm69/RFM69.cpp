/*
	...
	based on RFM69 driver definition by Felix Rusu (2014), felix@lowpowerlab.com (protected by GNU General Public License: http://www.gnu.org/licenses/gpl-3.0.txt)
...
void RFM69::setCallback(TCallback_void_void callback)
{
  _callback = callback;
}
...
void RFM69::receiveBegin() {
  ...
  while(0 == digitalRead(_interruptPin)); // simulate interrupt
