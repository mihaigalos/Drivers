...
public:
  ...
  //----------------------------------------------------------------------------
  /** @return Pin's level */
  inline __attribute__((always_inline)) bool read() { return *pinReg_ & bit_; }
  //----------------------------------------------------------------------------
  /** toggle a pin
   *
   ...
   */
  inline __attribute__((always_inline)) void toggle() { *pinReg_ = bit_; }
  //============================================================================
  /**
   ...
   */
  inline __attribute__((always_inline)) void highI() { writeI(1); }
  /**
   ...
   * This function will not change the interrupt state.
   */
  inline __attribute__((always_inline)) void lowI() { writeI(0); }
  /**
   * Set pin mode
   ...
   * This function will not change the interrupt state.
   */
  inline __attribute__((always_inline)) void modeI(bool mode) {
  ...
  inline __attribute__((always_inline)) void high() {
    ATOMIC_BLOCK(ATOMIC_FORCEON) { highI(); }
  }
  /**
  ...
  inline __attribute__((always_inline)) void low() {
    ATOMIC_BLOCK(ATOMIC_FORCEON) { lowI(); }
  }
  /**
   * Set pin mode
   ...
   * called in an ISR or where interrupts are disabled.
   */
  inline __attribute__((always_inline)) void mode(bool pinMode) {
    ATOMIC_BLOCK(ATOMIC_FORCEON) { modeI(pinMode); }
  }
  /**  Write pin.
   *
   * @param[in] level If output mode set pin high if true else low.
