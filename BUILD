...
cc_test(
    name = "unit_test_tea_4bytes_payload_crc_key_select_with_public_key",
    srcs = [
        "AVR/Encryption/test_unit_tea_4bytes_payload_crc_key_select_with_public_key.cpp",
    ],
    copts = DEFAULT_COMPILER_OPTIONS,
    tags = ["unit"],
    timeout = "eternal",
...
cc_test(
    name = "unit_test_tea_8bytes_payload_crc_key_select_with_public_key",
    srcs = [
        "AVR/Encryption/test_unit_tea_8bytes_payload_crc_key_select_with_public_key.cpp",
    ],
    copts = DEFAULT_COMPILER_OPTIONS,
    tags = ["unit"],
    deps = DEFAULT_TEST_DEPS + [":simple_tea"],
